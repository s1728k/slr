...
<body>
<?php $active = 'favorites'; include($app_key.'/admin/view/layouts/nav.php'); ?>
<div id="main" class="container-fluid">
	<div class="row">
		<div class="col-md-6">
			<h3>My Favorites <span style="font-size: 12px"><?php echo "(".$total_records.")"; ?></span></h3>
		</div>
		<div class="col-md-6">
			<ol class="breadcrumb">
	...
	<div class="row">
		<form id="sform" method="get" action="/admin/favorites">
		<div class="col-md-4">
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td><a onclick="removeFromFavorites('<?php echo $row['lead_cat']; ?>',<?php echo $row['id']; ?>)" style="cursor:pointer;">Remove</a></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
...
<script>
	...
	function removeFromFavorites(cat,id){
		$.post('/admin/remove_from_favorites',{'_token':'<?php echo $rand; ?>','cat':cat,'id':id},function(data,status){
			if(status=='success'){
